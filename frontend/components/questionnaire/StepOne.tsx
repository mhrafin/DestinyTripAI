        ...
        <Card className="max-w-4xl min-w-[320px] text-center items-center gap-0">
          ...
          <div className="flex flex-col mt-6 ">
            <div className="flex flex-col md:flex-row items-center justify-center *:h-64">
              ...
              >
                <Card className="h-full relative overflow-hidden p-0 text-white">
                  <div className="absolute z-10 p-6 flex flex-col gap-1 text-left pointer-events-none bottom-0">
                    ...
                    <CardDescription className="drop-shadow-md text-white">
                      Five-star resorts, private tours, and unparalleled
                      comfort.
                    </CardDescription>
                  </div>
                  <div className="absolute inset-0 z-5 bg-linear-to-t from-black to-transparent pointer-events-none"></div>
                  <Image
            ...
            <div className="flex flex-col md:flex-row items-center justify-center *:h-64 ">
              ...
              >
                <Card className="h-full md:flex-auto  relative overflow-hidden p-0 text-white">
                  <div className="absolute z-10 p-6 flex flex-col gap-1 text-left  pointer-events-none bottom-0">
              ...
              >
                <Card className="h-full md:w-[267px] md:flex-none  relative overflow-hidden p-0 text-white">
                  <div className="absolute z-10 p-6 flex flex-col gap-1 text-left pointer-events-none bottom-0">
