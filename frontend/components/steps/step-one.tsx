...
export function StepOne({ selectedStyle, setSelectedStyle }: StepOneProps) {
  return (
    <section>
      <div className="flex items-center justify-center pt-10">
        <Card className="max-w-4xl text-center gap-0">
          <h1 className="font-plus-jakarta-sans text-5xl font-bold mt-4">
            What&apos;s your travel style?
          </h1>
          <p className="font-light mt-3">
            Select the vibe that best matches your ideal getaway. This helps
            us tailor your AI recommendations.
          </p>
